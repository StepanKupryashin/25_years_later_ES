...
init:
    ...
    screen tfyl_main_menu():
        ...
        vbox:
            ...
            textbutton 'Главы' action ShowMenu('tfyl_select_chapter') at tfyl_button_hover
        ...
        add Solid("000"): # Заменяет fade
            at transform:
                ...
                on replace:
                    alpha 1.0
                    linear 1.0 alpha 0
    screen tfyl_select_chapter():
        key 'game_menu':
            action NullAction
        key "K_ESCAPE" action (Hide('tfyl_select_chapter', Dissolve(1.0)), Return())
        tag menu modal True
        style_prefix 'tfyl'
        use tfyl_menu_bg
...
init: # Нужно запихнуть в screens
    ...
    screen tfyl_diary():
        ...
        showif not show_mail_list and tfyl.mails:
            ...
            mousearea:
                area (550, 0, 1.0, 1.0)
                hovered SetScreenVariable("show_mail_list", False)
